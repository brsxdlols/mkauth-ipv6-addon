...
<style>.v6-wrap{width:calc(100vw - 48px);max-width:1800px;box-sizing:border-box;margin:20px auto;background:#0f172a;color:#e2e8f0;padding:22px;border-radius:12px}.v6-nav{display:flex;gap:8px;flex-wrap:wrap;margin:15px 0 22px}.v6-nav a,.v6-version a{padding:10px 14px;border-radius:7px;background:#1e293b;color:#e2e8f0;text-decoration:none}.v6-nav a.active,.v6-version a.active{background:#2563eb}.v6-grid{display:grid;grid-template-columns:1fr 1fr;gap:18px;margin-top:15px}.v6-card{background:#111c31;border:1px solid #334155;border-radius:10px;padding:16px;min-width:0}.v6-card textarea{width:100%;height:520px;background:#020617;color:#d1fae5;border:1px solid #334155;border-radius:7px;padding:12px;font:12px monospace;box-sizing:border-box}.v6-copy{background:#22c55e;color:#fff;border:0;border-radius:6px;padding:9px 14px;cursor:pointer}.v6-note{background:#422006;border:1px solid #d97706;padding:12px;border-radius:7px;margin:14px 0}@media(max-width:850px){.v6-wrap{width:calc(100vw - 20px)}.v6-grid{grid-template-columns:1fr}}</style></head><body>
